...
class LoginLogRepository implements \Foggyline\Sentinel\Api\LoginLogRepositoryInterface
{
    /**
     * @var \Foggyline\Sentinel\Model\ResourceModel\LoginLog
     */
    protected $resource;
    ...
    /**
     * @var \Foggyline\Sentinel\Model\ResourceModel\LoginLog\CollectionFactory
     */
    protected $logCollectionFactory;

    /**
     * @var \Foggyline\Sentinel\Api\Data\LoginLogSearchResultsInterfaceFactory
     */
    ...
    /**
     * @var \Foggyline\Sentinel\Api\Data\LoginLogInterfaceFactory
     */
    protected $dataLoginLogFactory;
    ...
    public function __construct(
        \Foggyline\Sentinel\Model\ResourceModel\LoginLog $resource,
        \Foggyline\Sentinel\Model\LoginLogFactory $logFactory,
        \Foggyline\Sentinel\Api\Data\LoginLogInterfaceFactory $dataLoginLogFactory,
        \Foggyline\Sentinel\Model\ResourceModel\LoginLog\CollectionFactory $logCollectionFactory,
        \Foggyline\Sentinel\Api\Data\LoginLogSearchResultsInterfaceFactory $searchResultsFactory,
        ...
        $this->dataLoginLogFactory = $dataLoginLogFactory;
    ...
    public function getById($logId)
    {
        ...
        if (!$log->getId()) {
            $errMsg = 'LoginLog with id "%1" does not exist.';
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $logModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $logData,
                $logModel->getData(),
                '\Foggyline\Sentinel\Api\Data\LoginLogInterface'
            );
